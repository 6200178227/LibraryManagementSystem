    ...
    <ul>
      ...
      <li><a href="LogoutServlet"><i class="fa fa-sign-in" aria-hidden="true"></i> Logout</a></li>
        ...
        <div style="box-shadow: 10px 5px #003333;width: 400px;height: 350px;background-color:rgba(1,1,0,0.1) ;border: black solid 10px;padding: 30px;margin-left: 450px;margin-top: 100px">
           ...
           {
               %>
               <table style="margin-left:70px; font-size: 20px;line-height: 40px;">
                   <tr><th style="text-align:center;">Name : </th><td><span style="color:#084cc3"><%=r.getString("fname")%></span></td></tr>
                   <tr><th style="text-align:center;">Member Id :</th><td><span style="color:#084cc3"><%=r.getString("mem_id")%></span></td></tr>
                   <tr><th style="text-align:center;">Department :</th><td><span style="color:#084cc3"><%=r.getString("deptt")%></span></td></tr>
